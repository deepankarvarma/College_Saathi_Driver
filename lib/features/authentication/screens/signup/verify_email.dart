...
import 'package:college_saathi/features/authentication/controllers/signup/verify_email_controller.dart';
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                  width: double.infinity,
                  child: TextButton(
                      onPressed: () =>controller.sendEmailVerifcation(), child: const Text(TTexts.resendEmail))),
            ],
          ),
        ),
      ),
