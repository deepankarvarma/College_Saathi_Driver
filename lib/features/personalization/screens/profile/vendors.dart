import 'package:college_saathi/features/personalization/controllers/important_controller.dart';
import 'package:college_saathi/features/personalization/controllers/vendors_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const TAppBar(
        title: Text('Vendor Details'),showBackArrow: true,
      ),
      body: Padding(
